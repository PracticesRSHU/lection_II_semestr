...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        tablemenu.add_command(label="Users" )
        tablemenu.add_command(label="Computers", command=self.view_records)
        tablemenu.add_command(label="Order")
        tablemenu.add_separator()
        tablemenu.add_command(label="Exit", command=root.quit)
        menubar.add_cascade(label="Таблиці", menu=tablemenu)
